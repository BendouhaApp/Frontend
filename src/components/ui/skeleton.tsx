...
function SkeletonProductGrid({ count = 4, className }: { count?: number; className?: string }) {
  return (
...
function SkeletonImage({ className, aspectRatio = 'square' }: { 
  className?: string
  ...
  return (
    <Skeleton className={cn(ratioClass[aspectRatio], 'w-full rounded-lg', className)} />
  )
}
