        ...
        <div className="relative mb-3 aspect-[3/4] overflow-hidden rounded-lg bg-navy-50 sm:mb-4 sm:rounded-xl">
          ...
          {product.inStock !== false && (
            <button
              ...
              className="absolute end-12 top-2 flex h-8 w-8 items-center justify-center rounded-full bg-white/90 text-navy-600 backdrop-blur-sm transition-colors hover:text-navy sm:hidden"
